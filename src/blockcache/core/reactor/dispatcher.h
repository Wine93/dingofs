...
#ifndef DINGOFS_BLOCKCACHE_CORE_REACTOR_DISPATCHER_H_
#define DINGOFS_BLOCKCACHE_CORE_REACTOR_DISPATCHER_H_
...
#endif  // DINGOFS_BLOCKCACHE_CORE_REACTOR_DISPATCHER_H_
