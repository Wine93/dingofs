...
#ifndef DINGOFS_BLOCKCACHE_REMOTE_REMOTE_CACHE_H_
#define DINGOFS_BLOCKCACHE_REMOTE_REMOTE_CACHE_H_
...
#endif  // DINGOFS_BLOCKCACHE_REMOTE_REMOTE_CACHE_H_
