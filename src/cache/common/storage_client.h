...
class PutBlockTask final : public TaskClosure {
 public:
  PutBlockTask(const BlockHandle& handle, const IOBuffer* block,
...
class RangeBlockTask final : public TaskClosure {
 public:
  RangeBlockTask(const BlockHandle& handle, off_t offset, size_t length,
                 IOBuffer* buffer,
                 blockaccess::BlockAccesser* block_accesser,
                 iutil::TaskExecutionQueueSPtr retry_queue);
...
class StorageClient {
 public:
  ...
  Status Put(const BlockHandle& handle, const IOBuffer* block);
