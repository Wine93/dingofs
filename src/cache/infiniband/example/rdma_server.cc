...
using ::dingofs::cache::infiniband::SlabPool;
...
class PooledBufferGuard {
 public:
  PooledBufferGuard(SlabPool* pool,
                    RDMABuffer* buffer)
  ...
  RDMABuffer* get() const { return buffer_; }
...
class BlockCacheServiceImpl final
 ...
 public:
  BlockCacheServiceImpl(SlabPool* pool,
