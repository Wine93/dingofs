...
#ifndef DINGOFS_SRC_CACHE_BLOCKCACHE_BLOCK_CACHE_METRIC_H_
#define DINGOFS_SRC_CACHE_BLOCKCACHE_BLOCK_CACHE_METRIC_H_
...
class BlockCacheMetric {
 ...
 public:
  BlockCacheMetric(BlockCacheOptions options, AuxMember aux_members)
      : metric_("dingofs_block_cache", aux_members) {
    metric_.upload_stage_workers.set_value(options.upload_stage_workers);
    metric_.upload_stage_queue_capacity.set_value(
        options.upload_stage_queue_size);
  }
...
#endif  // DINGOFS_SRC_CACHE_BLOCKCACHE_BLOCK_CACHE_METRIC_H_
